...
reg add "%sp%" /v datadir%sz%%spath%\Data /f
reg add "%sp%" /v installcompleted%dw%1 /f
reg add "%sp%" /v installloc%sz%%spath% /f
...
reg add "%sp64%" /v datadir%sz%%spath%\Data /f
reg add "%sp64%" /v installcompleted /t REG_DWORD /d 1 /f
reg add "%sp64%" /v installloc%sz%%spath% /f
...
reg add "%ep%" /v DataDir%sz%%spgap%\DataEP1\ /f
reg add "%ep%" /v InstallLoc%sz%%spgap% /f
...
reg add "%ep64%" /v DataDir%sz%%spgap%\DataEP1\ /f
reg add "%ep64%" /v InstallLoc%sz%%spgap% /f
...
reg add "%cc%" /v DataDir%sz%%sccp% /f
...
reg add "%cc64%" /v DataDir%sz%%sccp% /f
